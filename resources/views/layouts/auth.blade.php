...
<head>
    ...
    <!-- Vendor -->
  <link rel="stylesheet" href="{{ asset('backend/vendor/libs/%40form-validation/form-validation.css')}}" />
    ...
    <div class="authentication-inner row m-0">
      ...
      <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center p-5">
        <div class="w-100 d-flex justify-content-center">
          <img src="{{ asset('backend/img/illustrations/girl-with-laptop-light.png')}}" class="img-fluid scaleX-n1-rtl" alt="Login image" width="700" data-app-dark-img="{{ asset('backend/img/illustrations/girl-with-laptop-dark.png')}}" data-app-light-img="#" />
        </div>
      </div>
      <!-- /Left Text -->
...
<!-- / Content -->
    ...
    <!-- Vendors JS -->
    <script src="{{ asset('backend/vendor/libs/%40form-validation/popular.js')}}"></script>
    <script src="{{ asset('backend/vendor/libs/%40form-validation/bootstrap5.js')}}"></script>
    <script src="{{ asset('backend/vendor/libs/%40form-validation/auto-focus.js')}}"></script>
